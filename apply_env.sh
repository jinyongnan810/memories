...
if [ "$OS_TYPE" = "Darwin" ]; then
    # macOS
    SED_COMMAND="sed -i '' \"s/YOUR_API_KEY/${API_KEY}/g\" web/index.html && sed -i '' \"s/YOUR_API_KEY/${API_KEY_ANDROID}/g\" android/app/src/main/AndroidManifest.xml && sed -i '' \"s/YOUR_API_KEY/${API_KEY_IOS}/g\" ios/Runner/AppDelegate.swift"
else
    # Linux (Ubuntu)
    SED_COMMAND="sed -i \"s/YOUR_API_KEY/${API_KEY}/g\" web/index.html && sed -i \"s/YOUR_API_KEY/${API_KEY_ANDROID}/g\" android/app/src/main/AndroidManifest.xml && sed -i \"s/YOUR_API_KEY/${API_KEY_IOS}/g\" ios/Runner/AppDelegate.swift"
fi
